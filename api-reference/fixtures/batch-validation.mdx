...
<ResponseField name="metadata" type="BatchMetadata">
...
<ResponseField name="totalUpdateCount" type="int32">
  Total number of updates in the batch
</ResponseField>

<ResponseField name="numUniqueFixtures" type="int32">
  Number of unique fixtures in the batch
</ResponseField>

<ResponseField name="overallBatchStartTs" type="int64">
  Start timestamp of the batch
</ResponseField>

<ResponseField name="overallBatchEndTs" type="int64">
