---
title: "Introduction"
description: "TxODDS Oracle - Hybrid on-chain/off-chain sports data and validation system"
---

## Overview

TxODDS Oracle (TxLINE) is a hybrid Solana on-chain and TxODDS hosted off-chain system that provides cryptographically verifiable sports data with on-chain validation.
...
<Tabs>
  ...
  <Tab title="Solana DevNet">
    ...
    ```
    API: https://oracle-dev.txodds.com/api/
...
Follow the [Quickstart Guide](/documentation/quickstart) to begin accessing the TxODDS Oracle API.
