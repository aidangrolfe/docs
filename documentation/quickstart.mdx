...
## Fund Your Solana Account (Optional)

Before you can access the TxODDS Oracle API, you need to have USDT in your Solana wallet. If you already have USDT on Solana, you can skip this step.

import { WalletConnector } from "/snippets/wallet-connector.jsx"
